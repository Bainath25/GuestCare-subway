...
public class Website_Mobile_Base {
	 ...
	 * 
	 */
	static String Website_Mobile="//input[@id='v2main_0_insetcontainer_6cfebaeb54424adc88c25050d0487f87_0_btnYourDigitalOrder_WebM']";
	...
	public static void Screenshot() throws IOException
	{
		...
		File Dest=new File("./target/WebMobile.png");
	...
	public static void Execution() throws InterruptedException
	{
		...
		scrollBy();
		wait(2);
		driver.findElement(By.xpath(Website_Mobile)).click();
		...
		wait(2);
		System.out.println("Successfully Submitted Website Mobile Form");
		wait(3);
		quit_browser();
		}
		}
