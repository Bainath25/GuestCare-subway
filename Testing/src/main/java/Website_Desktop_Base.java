...
public class Website_Desktop_Base {
	/*
	 * 
	 * This are Xpaths
	 * 
	 */
	static String Website_Desktop="//input[@id='v2main_0_insetcontainer_6cfebaeb54424adc88c25050d0487f87_0_btnYourDigitalOrder_WebDL']";
	...
	public static void Screenshot() throws IOException
	{
		...
		File Dest=new File("./target/WebDesktop.png");
	...
	public static void Execution() throws InterruptedException
	{
		...
		scrollBy();
		wait(2);
		driver.findElement(By.xpath(Website_Desktop)).click();
		...
		wait(1);
		Select browser=new Select(driver.findElement(By.xpath(Browser_select)));
		...
		wait(2);
		System.out.println("Successfully Submitted Website Desktop Form");
		wait(3);
		quit_browser();
		}
		}
