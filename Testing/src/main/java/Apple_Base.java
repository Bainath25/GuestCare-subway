...
public class Apple_Base {
	...
	public static void Screenshot() throws IOException
	{
		...
		File Dest=new File("./target/Apple.png");
	...
	public static void Execution() throws InterruptedException
	{
		...
		//Select the Mobile App Apple
		scrollBy();
		wait(2);
		driver.findElement(By.xpath(Mobile_App_Apple)).click();
		...
		wait(1);
		driver.findElement(By.xpath(App_version)).sendKeys("12.0");
		...
		wait(2);
		System.out.println("Successfully Submitted Apple Form");
		wait(3);
		quit_browser();
		}
		}
